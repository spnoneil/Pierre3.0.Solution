...
--
-- Host: localhost    Database: scott_oneil
-- ------------------------------------------------------
...
CREATE TABLE `flavors` (
  ...
  `FlavorName` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE `treats` (
  ...
  `TreatName` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `TreatDesc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `UserId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`TreatId`),
...
-- Dump completed on 2021-03-26 15:46:29
